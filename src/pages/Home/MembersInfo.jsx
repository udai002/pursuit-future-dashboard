...
const MembersInfo = () => {
    ...
    const FetchMembers = async () => {
        try {
            ...
            const updatedEmployees = result.employees.map(emp => ({
                ...emp,
                amount: 100000,
            }));

            const total = updatedEmployees.length * 100000;
        ...
        <div className='mt-[5%]'>
            ...
            <div className='flex justify-end mt-5 pr-10'>
                <h2 className='text-lg font-semibold'>
                    Total Team Target: <span className='text-green-600'>Rs {totalTarget.toLocaleString()}</span>
                </h2>
            </div>
        </div>
    )
